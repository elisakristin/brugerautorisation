 ...
 */
package main.java.brugerautorisation.server;
...
public class BenytBrugerdatabase {
    ...
    if (scanner.nextLine().toLowerCase().startsWith("n")) {
      ...
      System.exit(0);
		...
		main.java.brugerautorisation.transport.rmi.Brugeradminserver.main(null);
		main.java.brugerautorisation.transport.soap.Brugeradminserver.main(null);
